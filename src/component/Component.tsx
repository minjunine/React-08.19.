...
// 클래스형 컴포넌트, 함수형 컴포넌트가 존재 (함수형 컴포넌트만 사용)
...
// VSCode의 ES7+ / React/Reduce/React-Native snippets 확장 설치 후
...
export default function Component () {
    ...
    // 1. 반드시 하나의 요소를 반환
    // 2. 모든 태그를 닫아야함
    // 3. 속성들을 JSX로 지정된 이름을 사용해야함 (lowerCameClass)
    // 4. 주석을 사용할 땐 {/*  */}를 사용
    return (
        <>
            {/* <input className='' /> */}       //자바스크립트 주석

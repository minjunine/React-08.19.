...
// - useContex : 컴포넌트 트리 상에서 전역적으로 상태를 공유하고자 할때 사용하는 함수
...
// - hook 함수는 반드시 컴포넌트 코드 블럭 라인데 존재해야함
// const [state2, setState2] = setState<number>(0);
...
export default function HookComponent1() {
    ...
    return (
    <div>
        {state1} <button onClick={onAddClickHandler}>+</button>
